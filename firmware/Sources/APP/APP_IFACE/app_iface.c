...
{
	if ((data->electricMsgStatus == MID_REG_ENABLED && data->electricMsgPeriod < EPC_CONF_periodic_time_min.electricMsgPeriod) || (data->tempMsgPeriod < EPC_CONF_periodic_time_min.tempMsgPeriod && data->tempMsgStatus == MID_REG_ENABLED) || (data->usrHeartBeatStatus == MID_REG_ENABLED && data->usrHeartBeatPeriod < EPC_CONF_periodic_time_min.usrHeartBeatPeriod))
	{
										 ...
										 MID_REG_limit_s *limits, MID_REG_control_s *consign)
{
	...
	tmp_ptr_control = control;
	tmp_ptr_meas = meas;
	tmp_ptr_status = status;
	tmp_ptr_limits = limits;
	tmp_ptr_consign = consign;
